...
<body class="sarchbody">
	...
	<div class="formbody">
		<div class="formtitle">
			...
			<ul class="forminfo">
				<li><label>权限组名称</label><i><label><img src="images/${gup.img}" />&nbsp;${gup.title}</label></i></li>
				<li><label>权限组类型</label><i><label>${gup.type}</label></i></li>
			</ul>
	</div>
	<div class="formbody">
		<table class="tablelist">
			...
			<tbody>
				<c:if test="${gup.action != null}">
					<c:forEach items="${gup.action}" var="action">
						<tr>
							<td>${action.title}</td>
